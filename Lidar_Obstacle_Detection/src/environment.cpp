...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
   ...
   // renderPointCloud(viewer, cloud, "PointCloud" );
    ...
    std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> segmentCloud = pointProcessor->SegmentPlane(cloud, 10, 0.7);
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud){
    ...
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessorI->myRANSAC(filterCloud, 20, 0.2);
    //renderPointCloud(viewer,segmentCloud.first,"obstacles",Color(1,0,0));
...
//   }
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->myClustering(segmentCloud.first,  0.7, 20, 250);
